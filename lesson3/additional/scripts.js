...
let nambers = [1,4,6,10,-4];

console.log(nambers);
// // - з 5 стічкових значень
//
let strings1 = ['kobra','muravej','zhuk','Mbappe','Ball'];
console.log(strings1);

// - з 5 значень стрічкового, числового та булевого типу

let mixed = ['john', 4, true, 'richard', 8, true, 'pepper', 422, false, 'doctor', 1, true, 'megan', -100, false];
...
while (index0 < array.length) {
    if (array[index0] % 2 !== 0) {
        console.log(array[index0]);
    }
    index0++
}
console.log('New test');
...
let index3 = reverseArray.length - 1;

while (index3 >= 0) {
    console.log(reverseArray[index3]);
    index3--
}
console.log('New test');
...
let index4 = reverseArray.length - 1;

while (index4 >= 0) {
    if (reverseArray[index4] % 2 !== 0) {
        console.log(reverseArray[index4])
    }
    index4--
}
console.log('New test');
...
console.log('New test');
// 5. перебрати циклом while та вивести  числа тільки парні  значення
let index5 = reverseArray.length - 1;

while (index5 >= 0) {
    if (reverseArray[index5] % 2 === 0) {
        console.log(reverseArray[index5])
    }
    index5--
}
console.log('New test');
...
let randomNumbers = [1, 7, 100, -2, 0, 3, 45, 988, 42, 112];
...
let randomStrings = ['alo', 'garazh', 'ja', 'stas', 'pepsi', 'fanta', 'orwell', 'rober', 'griffins', 'champ'];
for (const item of randomStrings) {
    console.log(item)
}
console.log('New test');
// - Створити масив з 10 елементів будь-якого типу. Вивести в консоль всі його елементи в циклі.
let mixedArray = ['john', 4, true, 'richard', 8, false, 'pepper', 422, 'doctor', 1];
...
emptyArrays[0] = true;
emptyArrays[1] = 'richard';
emptyArrays[2] = false;
emptyArrays[3] = 2;
emptyArrays[4] = 'john';
emptyArrays[5] = 1;
emptyArrays[6] = 'viktor';
emptyArrays[7] = true;
emptyArrays[8] = false;
emptyArrays[9] = -999;
...
console.log(emptyArrayA)
console.log('New test');
//     b. заповнити його 50 непарними числами за допомоги циклу

let emptyArrayB = [];
for(let i=1,j= emptyArrayB.length;i<100;i+=2,j++){
    emptyArrayB[j] = i
}
...
let emptyArrayC = [];
for(let i=0;i<20;i++){
    emptyArrayC[i] = Math.floor(Math.random()*100)
}
console.log(emptyArrayC)
console.log('New test');
// d. Заповнити масив 20ма рандомними чисалами в діапазоні від 8 до 732 (Google: Generate random number JS)
let emptyArrayD = [];
for(let i=0;i<20;i++){
    emptyArrayD[i] = Math.floor(Math.random()*(732-8)+8)
}
console.log(emptyArrayD)
console.log('New test');
// 2. Вивести за допомогою console.log кожен третій елемен
for(let i=2;i<emptyArrayC.length;i+=3){
    console.log(emptyArrayC[i])
}
console.log('New test');
// 3. Вивести за допомогою console.log кожен третій елемен тільки якщо цей елемент є парним.
for(let i=2;i<emptyArrayC.length;i+=3){
    if(emptyArrayC[i]%2 === 0){
        console.log(emptyArrayC[i])
    }
}
console.log('New test');
...
for(let i=2;i<emptyArrayC.length;i+=3){
    if(emptyArrayC[i]%2 === 0){
        console.log(emptyArrayC[i])
        newArrayThree.push(emptyArrayC[i])
    }
}
...
let evenArray = [ 1, 2, 3, 5, 7, 9, 56, 8, 67 ];
...
let priceNumbers =  [100,250,50,168,120,345,188];
let fullPrice = 0;
for(let i=0;i<priceNumbers.length;i++){
    fullPrice += priceNumbers[i]
}
console.log(Math.floor(fullPrice/priceNumbers.length))
console.log('New test');
...
let mixedArrayA = [1,'John',true,false,2,'Igor',3,true,false,17];
let mixedArrayB = [];

for(let i=0,j=mixedArrayB.length;i<mixedArrayA.length;i++){
    if(typeof mixedArrayA[i] === 'number'){
        mixedArrayB[j] = mixedArrayA[i]
        j++
    }
}
console.log(mixedArrayB);
console.log('New test');
...
// Масиви:
let usersWithId = [
        {id: 5, name: 'tolya', age: 22, status: true},
...
let citiesWithId = [
    ...
    {user_id: 5, country: "Ukraine", city: 'Kyiv'},
...
// - Взяти масив з 10 чисел або створити його. Створити 2й порожній масив. За допомогою будь-якого циклу скопіювати значення одного масиву в інший.
    let newArray = [];
    for(let i=0;i<numberzz.length;i++){
        newArray[i] = numberzz[i]
    }
...
let index6 = 0;
let word2 = '';
while (index6<abc.length){
    word2 = word2+abc[index6];
    index6++
}
console.log(word2);
console.log('New test');
